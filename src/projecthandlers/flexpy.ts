...
export class FlexpyProjectHandler extends AbstractHandler {
    ...
    public checkInternalDependencies(apply: boolean) {
        ...
        debugLog("Checking internal dependencies for Flexpy project handler", "warning");
        ...
        debugLog("Detected boards: " + boardInts.join(","), "warning");
